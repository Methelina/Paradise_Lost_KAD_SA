...
Из [amule-daemon-config](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config) допускается использовать как стартовые ресурсы: [GeoIP.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/GeoIP.dat), [nodes.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/nodes.dat), [server.met](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/server.met), [staticservers.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/staticservers.dat), [ipfilter.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/ipfilter.dat), [ipfilter_static.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/ipfilter_static.dat), [shareddir.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/shareddir.dat) и [Temp](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/Temp).

Из корня проекта импортируется [shared_files.json](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/shared_files.json) как начальный список шаринга. Файлы [known.met](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/known.met), [known2_64.met](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/known2_64.met), [clients.met](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/clients.met), [preferences.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/preferences.dat), [preferencesKad.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/preferencesKad.dat) и [cryptkey.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/cryptkey.dat) не являются обязательными для первого старта; они относятся к compatibility/import layer.
...
Реализовать UInt128, XOR distance, routing buckets, bootstrap из nodes URL или импортированного [nodes.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/nodes.dat), UDP packet codec, hello/ping/pong, базовый routing maintenance и firewall checks. Основные источники: [UInt128.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/kademlia/utils/UInt128.cpp), [RoutingZone.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/kademlia/routing/RoutingZone.cpp), [KademliaUDPListener.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/kademlia/net/KademliaUDPListener.cpp) и [UDPFirewallTester.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/kademlia/kademlia/UDPFirewallTester.cpp).
...
Реализовать `ipfilter.dat`, `ipfilter_static.dat`, URL auto-update, GeoIP lookup через [GeoIP.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/GeoIP.dat), UPnP, NAT-PMP и firewall diagnostics. Основные источники: [IPFilter.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/IPFilter.cpp), [IPFilterScanner.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/IPFilterScanner.cpp) и [UDPFirewallTester.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/kademlia/kademlia/UDPFirewallTester.cpp).
...
Реализовать import-once bridge для [shared_files.json](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/shared_files.json), [shareddir.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/shareddir.dat), [server.met](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/server.met), [nodes.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/nodes.dat), [GeoIP.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/GeoIP.dat), [ipfilter.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/ipfilter.dat), [ipfilter_static.dat](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/ipfilter_static.dat) и при необходимости partial files из [Temp](file:///O:/Work/Coding/Paradise_Lost_KAD_SA/amule-daemon-config/Temp).
