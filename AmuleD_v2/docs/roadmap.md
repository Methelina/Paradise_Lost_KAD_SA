...
ED2K `OP_LOGINREQUEST` builder и async TCP session уже реализованы и проверены на loopback fake server. Реализованы парсеры `OP_SERVERIDENT`, `OP_SERVERSTATUS`, `OP_SERVERMESSAGE` и `OP_IDCHANGE`, включая high/low-ID классификацию. Далее реализуются server search, source request, reconnect и server statistics поверх этой сессии. Основные источники: [Client2Server\TCP.h](file:///O:/Work/Coding/aMule-2.3.3/src/include/protocol/ed2k/Client2Server/TCP.h), [Client2Server\UDP.h](file:///O:/Work/Coding/aMule-2.3.3/src/include/protocol/ed2k/Client2Server/UDP.h), [ServerList.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/ServerList.cpp), [ServerConnect.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/ServerConnect.cpp) и [SearchList.cpp](file:///O:/Work/Coding/aMule-2.3.3/src/SearchList.cpp).
